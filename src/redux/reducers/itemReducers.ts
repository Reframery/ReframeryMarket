...
export const itemCreateReducer = (state = {}, action: PayloadAction) => {
  switch (action.type) {
...
export const itemUpdateReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const itemImageUpdateReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const itemDeleteReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const itemGetReducer = (state = { loading: true, item: {} }, action: PayloadAction) => {
  switch (action.type) {
