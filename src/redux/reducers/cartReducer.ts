...
export const createCartReducer = (state = {}, action: PayloadAction) => {
  switch (action.type) {
...
// get cart details
export const getCartReducer = (state = {}, action: PayloadAction) => {
  switch (action.type) {
...
export const addItemsToCartRducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const numOfCartsForUserReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const updateItemCountReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const getUserCartsReducer = (
  state = { loading: true, carts: [] },
...
// delete a cart
export const deleteCartReducer = (state = { loading: true }, action: PayloadAction) => {
  switch (action.type) {
...
export const deleteItemFromCartReducer = (
  state = { loading: true },
  action: PayloadAction
) => {
  switch (action.type) {
